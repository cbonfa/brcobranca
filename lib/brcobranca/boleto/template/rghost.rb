    ...
    module Template
      ...
      module Rghost
        ...
        def modelo_generico_cabecalho(doc, boleto)
          ...
          doc.moveto :x => '5.3 cm' , :y => '23.95 cm'
          doc.show "#{boleto.banco}-#{boleto.banco_dv}", :tag => :grande
          doc.moveto :x => '7.6 cm' , :y => '23.95 cm'
          ...
          boleto.infos.each do |key, value|
            doc.text_area value, :width => "20 cm", :text_align => :left, :x => key[0].to_s + " cm", :y => (29.6 - key[1]).to_s + " cm", :row_height => 0.26,:tag => :pequeno
        ...
        def modelo_generico_rodape(doc, boleto)
          ...
          doc.moveto :x => '5.3 cm' , :y => '16.9 cm'
          doc.show "#{boleto.banco}-#{boleto.banco_dv}", :tag => :grande
          doc.moveto :x => '7.6 cm' , :y => '16.9 cm'
          doc.show boleto.codigo_barras.linha_digitavel, :tag => :grande
